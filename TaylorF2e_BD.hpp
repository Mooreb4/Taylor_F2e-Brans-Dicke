...
#ifndef TAYLORF2E_BD_HPP_
#define TAYLORF2E_BD_HPP_
...
//	TaylorF2e(double M_in, double eta_in, double e_in, double ampmag, double f0_in, double fend_in, double df_in);
	TaylorF2e(double M_in, double eta_in, double e_in, double ampmag, double b_in, double f0_in, double fend_in, double df_in);
//	TaylorF2e(double M_in, double eta_in, double e_in, double thet_in, double phi_in, double psi_in, double iot_in, double lamc_in, double lc_in, double tc_in, double D_in, double f0_in, double fend_in, double df_in);
	...
	double get_phase_j_cycles(int j);
	int calls;
	int count;
	int calls_guess;
	vector<double> get_p0_e0_circ();
	vector<double> get_p0_e0_mid();
	vector<double> get_p0_e0_quar();
...
private:
	...
	vector<double> C_vec;
	vector<double> t_vec;
	vector<double> tbd_vec;
	vector<double> lam_vec;
	vector<double> l_vec;
	vector<double> lbd_vec;
	vector<double> y_vec;
	vector<double> ybd_vec;
